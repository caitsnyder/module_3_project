from modules.organizers.split_keeper import SplitKeeper
import numpy as np
import pandas as pd
...
class Splitter:
    ...
    #     setattr(self.split_dfs, key, merged_df)
    ...
    #             getattr(self.split_dfs, target_df_key)[col] = 0
